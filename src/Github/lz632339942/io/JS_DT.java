...
public class JS_DT {
	...
	public void test() {
        ...
        HtmlPage page = null;
        try {
            page = webClient.getPage("http://localhost:4000/gallery/");//尝试加载上面图片例子给出的网页
        } catch (Exception e) {
            e.printStackTrace();
        }finally {
            webClient.close();
        ...
        List<Element> infoListEle = document.getElementsByAttributeValue("class", "photo_thumbnail jg-entry entry-visible");//获取元素节点等
